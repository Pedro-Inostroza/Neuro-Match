...
NEURO//MATCH es un juego de memoria interactivo de temática cyberpunk. El objetivo es encontrar todas las parejas de cartas en el tablero. Este proyecto fue desarrollado con un enfoque en la optimización del rendimiento, la seguridad del código y el manejo eficiente del estado utilizando JavaScript puro, sin frameworks ni librerías externas.

## 🛠️ Tecnologías Utilizadas

* **HTML5:** Estructura base.
* **CSS3:** Estilos visuales de estética cyberpunk y manejo de la cuadrícula visual.
* **Vanilla JavaScript (ES6+):** Lógica del juego y manipulación del DOM.
* **Web Audio API:** Síntesis de efectos de sonido nativos.
...
* **Clic:** Voltear carta.
* **Tecla `R`:** Reiniciar.
* **Selector de dificultad:** Permite cambiar el tamaño del tablero.
